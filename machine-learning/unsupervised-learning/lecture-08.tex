...
Describe the Hamiltonian Monte Carlo dynamical system.; \begin{itemize}
    \item Positions \mathbf{x} correspond to the RVs of interest. 
    \item These are augmented by momentum variables \mathbf{v}.
    \item $p(\mathbf{x, v})\propto \exp(-H(\mathbf{x, v}))$
    \item TODO: complete later, slides 29-32 skipped
\end{itemize}

% todo: skipped HMC slides 29-32, don't think I need to know the equations, but understand it and make that into FCs
...
% resume at langevin MC slide s34
